...
exports.deleteFoodCategory = function (foodCategoryId) { return function (dispatch) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, axios_1["default"]["delete"]("https://kiyoshi-restaurant.xyz/api/food-categories/" + foodCategoryId + "/delete")["catch"](function (error) { return console.error(error); })];
            case 1:
                response = _a.sent();
                if (response) {
                    dispatch({
